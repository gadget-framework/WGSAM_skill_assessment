...
init.num.age0 <- data.frame(year=40, step=1, area="noba_area", age="age0", number=0)

init.num <- rbind(init.num.age0, init.num)
...
ageVec <- c(0, unlist(defaults$age))
attributes(ageVec)$names <- paste0("age", c(0:5))
